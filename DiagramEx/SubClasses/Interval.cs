...
namespace DiagramEx.SubClasses
{
    ...
    internal readonly struct Interval<T> : IEquatable<Interval<T>>, ICloneable<Interval<T>> where T : IComparable<T>
    {
        /* ------------------------------------------------------------------------------------------ */
    ...
    internal readonly struct Interval : IComparable<double>, IFormattable, IEquatable<Interval>
    {
        /* -------------------------------------------------------------------------------------------- */
